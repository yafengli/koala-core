...
public class PersonMain {
    ...
    public static void init() {
        ...
        try {
            ...
            MappingTool.run(conf, new String[]{dir + "org/helloworld/Person.java", dir + "hellojpa/Message.java"}, Options.EMPTY);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//        ejb();
    ...
    private static void run() {
        ...
        for (Person item : items) {
            System.out.printf("[%s,%s,%s]/n", item.getName(), item.getAddress(), item.getMessage());
        }
        em.close();
        factory.close();
    }
