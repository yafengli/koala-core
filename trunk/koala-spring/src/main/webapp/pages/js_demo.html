...
<html>
	<head>
		...
		<link type="text/css" href="<%=request.getContextPath()%>/resources/css/smoothness/jquery-ui.custom.css" rel="stylesheet" />	
		<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery/jquery.min.js"></script>
		<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/jquery/jquery-ui.custom.min.js"></script>
	...
	<p style="font-weight: bold; margin: 2em 0 1em; font-size: 1.3em;">YOUR COMPONENTS:</p>
		...
		<div id="tabs">
			<ul>
				...
				<li><a href="html/1.html">Four</a></li>
				<li><a href="html/2.html">Five</a></li>
			</ul>
