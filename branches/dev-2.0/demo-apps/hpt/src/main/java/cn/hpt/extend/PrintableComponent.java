...
public class PrintableComponent implements Printable {
	...
	/**
	 * This is the "callback" method that the PrinterJob will invoke. This
	 * method is defined by the Printable interface.
	 */
	public int print(Graphics g, PageFormat format, int pagenum) {
		...
		// We're passed a Graphics object, but it can always be cast to
		// Graphics2D
