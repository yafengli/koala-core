...
<table width="100%">
	<tr>
		<td><span style="font-size: 15; color: red">
		使用@Annotation注解的Spring MVC演示 </span>
		</div>
		...
		<a href="hello/123/test.shtml">Test Web Service,using the param
		'hello' by urlrewrite.</a><br />
		<hr />
		...
		<hr />
		<a href="tiles/home/23/">Tiles 2测试</a></td>
		<td>
		<div><span>JFreeChart</span></div>
		<img src="jfreechart.ftl" alt="JFreeChart-图表" /></td>
		<td>
		<div>Flash Chart</div>
		<jsp:include page="/ofc.jsp" flush="true" /></td>
	</tr>
</table>
