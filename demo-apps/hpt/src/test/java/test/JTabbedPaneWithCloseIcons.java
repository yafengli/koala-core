...
public class JTabbedPaneWithCloseIcons extends JTabbedPane implements MouseListener {
	public static void main(String[] args){
		JFrame f=new JFrame();
		JTabbedPaneWithCloseIcons actionTabbedPane=new JTabbedPaneWithCloseIcons();
		f.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
		actionTabbedPane.addTab("ione",null,new JPanel(),"and");
		actionTabbedPane.addTab("two",null,new JPanel(),"two");
		f.getContentPane().add(actionTabbedPane, BorderLayout.CENTER);
		f.pack();
		f.setVisible(true);
	}
